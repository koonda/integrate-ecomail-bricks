...
// Nastavení cesty k SDK – dle tvé struktury, SDK se nachází v "wordpress-sdk/src/Client.php"
...
if ( file_exists( $client_file ) ) {
    ...
    // Volitelně můžete zastavit načítání pluginu:
    // wp_die( 'SureCart SDK nebyl nalezen. Plugin nemůže být spuštěn.' );
}
...
// Nastavení textdomain pro překlady – načteme při init, aby se překlady načetly ve správný čas
...
if ( ! function_exists( 'bf_ecomail_verify_license' ) ) {
    function bf_ecomail_verify_license() {
        ...
        if ( ! $sc_license->is_valid() ) {
            // Deaktivace pluginu, pokud licence není platná
 ...
 */
if ( ! function_exists( 'bf_ecomail_register_update_checker' ) ) {
